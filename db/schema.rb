...
ActiveRecord::Schema.define(version: 20180201082635) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "add_leaves", force: :cascade do |t|
    t.integer "amount"
  ...
  create_table "dep_head_onboardings", force: :cascade do |t|
    t.integer "employment_id"
  ...
  create_table "employments", force: :cascade do |t|
    ...
    t.bigint "manager_id"
    t.index ["manager_id"], name: "index_employments_on_manager_id"
  end
  ...
  create_table "lr_mails", force: :cascade do |t|
    t.integer "company_id"
    t.integer "sender_id"
    t.integer "recipient_id"
    t.integer "employment_id"
  ...
  create_table "project_head_onboardings", force: :cascade do |t|
    t.integer "employment_id"
    t.integer "department_id"
    t.date "start_date"
    t.date "end_date"
  ...
  create_table "rejection_messages", force: :cascade do |t|
    t.text "description"
    t.integer "leave_request_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "user_import_passwords", force: :cascade do |t|
    t.integer "user_id"
    t.string "password"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
